                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(DoughnutChart, { data: this.props.doughnutData }),
                                React.createElement(
                                    "div",
...
var BubblyCardRunner = function (id, container, dataFromPage, sourceurl, returnUrl) {
    ...
    jQuery.ajax({
        ...
        //debugger;
        React.render(React.createElement(DBTS, { id: id, doughnutData: doughnutData, ClientBar: ClientBar, Projects: Projects, title: title, count: totalCount, returnurl: returnurl }), container);
    });
};
