				...
				<div className="row">
		            ...
		            <div className="card medium z-depth-3">
			            <div className="card-image">
			              <img className="materialboxed" src={this.props.data.Photos[0].Url}/>
			              <span className="card-title"><a href={this.props.returnUrl}>{this.props.data.Name}</a></span>
			            </div>
...
React.render(<MediumCardMD data={data} returnUrl={"http://bharatmovies.social"}/>,document.getElementById("MediumCard"));