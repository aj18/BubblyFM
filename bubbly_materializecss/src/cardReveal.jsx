				...
				<div className="row">
			        ...
			        <div className="card z-depth-3">
				        <div className="card-image waves-effect waves-block waves-light">
				          <img className="activator" src={this.props.data.Photos[0].Url}/>
				        </div>
				        <div className="card-content">
				          <span className="card-title activator grey-text text-darken-4">{this.props.data.Name} <i className="mdi-navigation-more-vert right"></i></span>
				          <p><a href={this.props.returnUrl}>This is a Link</a></p>
				        </div>
...
React.render(<CardRevealMD data={data} returnUrl={"http://bharatmovies.social"}/>,document.getElementById("CardReveal"));