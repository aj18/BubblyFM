...
var SmallCardMD = React.createClass({
	displayName: "SmallCardMD",
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					"div",
					{ className: "card small z-depth-3" },
					React.createElement(
						"div",
...
React.render(React.createElement(SmallCardMD, { data: data, returnUrl: "http://bharatmovies.social" }), document.getElementById("SmallCard"));
