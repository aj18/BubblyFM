	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					"div",
					{ className: "card blue-grey darken-1 z-depth-3" },
					React.createElement(
						"div",
...
React.render(React.createElement(BasicCard, { data: data, returnUrl: "http://bharatmovies.social" }), document.getElementById("basiccard"));
