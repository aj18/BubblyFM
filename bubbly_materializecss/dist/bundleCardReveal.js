...
var CardRevealMD = React.createClass({
	displayName: "CardRevealMD",
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement("img", { className: "activator", src: this.props.data.Photos[0].Url })
					),
					React.createElement(
						"div",
...
React.render(React.createElement(CardRevealMD, { data: data, returnUrl: "http://bharatmovies.social" }), document.getElementById("CardReveal"));
