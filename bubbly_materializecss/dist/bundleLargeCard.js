...
var LargeCardMD = React.createClass({
	displayName: "LargeCardMD",
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement("img", { src: this.props.data.Photos[0].Url }),
						React.createElement(
							"span",
...
React.render(React.createElement(LargeCardMD, { data: data, returnUrl: "http://bharatmovies.social" }), document.getElementById("LargeCard"));
