...
var CardPanelMD = React.createClass({
	displayName: "CardPanelMD",
...
React.render(React.createElement(CardPanelMD, { data: data, returnUrl: "http://bharatmovies.social" }), document.getElementById("CardPanel"));
