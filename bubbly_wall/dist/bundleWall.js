...
var ItemYoutube = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      "div",
      { className: "grid-item grid-item--YouTube-width grid-item--YouTube-height card", style: { margin: "5px 5px 5px 5px" } },
      React.createElement(
        "div",
        { className: "card-image", style: s4 },
        React.createElement("span", { style: s1, className: "fa fa-youtube" }),
        React.createElement(
          "div",
          { className: "white-text", style: { padding: "90px 0px 0px 0px" } },
          React.createElement(
            "span",
            { style: s2, className: "amber darken-2" },
            this.props.text.substr(0, 30)
          )
        ),
        React.createElement(
          "span",
...
var ItemVimeo = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      "div",
      { className: "grid-item grid-item--Vimeo-width grid-item--Vimeo-height", style: { margin: "5px 5px 5px 5px" } },
      React.createElement("div", { style: s4 })
    );
  }
});

var ItemFbTextPhoto = React.createClass({
  displayName: "ItemFbTextPhoto",
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "grid-item grid-item--fbTextPhoto-width grid-item--fbTextPhoto-height card", style: { margin: "5px 5px 5px 5px", "background-color": "#3a5795" } },
        React.createElement(
          "div",
          { className: "row" },
          React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement("p", { style: s1, className: "fa fa-facebook" }),
              React.createElement(
                "p",
                { style: s2 },
                this.props.text.substr(0, 70) + "..."
              ),
              React.createElement(
                "p",
                { style: s3 },
...
var ItemFbPhoto = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "grid-item grid-item--fbPhoto-width grid-item--fbPhoto-height card", style: { margin: "5px 5px 5px 5px" } },
        React.createElement("div", { className: "card-image", style: s4 })
      )
    );
  }
});
...
var ItemfbText = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "grid-item grid-item--text-width grid-item--text-height card-panel", style: { margin: "5px 5px 5px 5px", "background-color": "#3a5795" } },
        React.createElement(
          "div",
          { className: "white-text" },
          React.createElement("p", { style: s1, className: "fa fa-facebook" }),
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { style: s4 },
          React.createElement("span", { style: s1, className: "fa fa-twitter" }),
          React.createElement(
            "div",
            { className: "white-text", style: { padding: "90px 0px 0px 0px" } },
            React.createElement(
...
var ItemtwText = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "grid-item grid-item--text-width grid-item--text-height card-panel card-content", style: s4 },
        React.createElement(
          "div",
          { className: "white-text" },
          React.createElement("p", { style: s1, className: "fa fa-twitter" }),
          React.createElement(
            "p",
            { style: s2 },
            this.props.data.substr(0, 70) + "..."
...
var ItemTmbTextPhoto = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "grid-item grid-item--fbTextPhoto-width grid-item--fbTextPhoto-height card", style: { margin: "5px 5px 5px 5px" } },
        React.createElement(
          "div",
          { style: s4 },
          React.createElement("p", { style: s1, className: "fa fa-tumblr" }),
          React.createElement(
            "div",
            { className: "white-text", style: { padding: "90px 0px 0px 0px" } },
            React.createElement(
...
var ItemTmbText = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "grid-item grid-item--text-width grid-item--text-height card-panel", style: { margin: "5px 5px 5px 5px", "background-color": " #36465d" } },
        React.createElement(
          "div",
          { className: "white-text" },
          React.createElement("p", { style: s1, className: "fa fa-tumblr" }),
...
var ItemInstagramPhoto = React.createClass({
  displayName: "ItemInstagramPhoto",
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "grid-item grid-item--text-width grid-item--text-height card", style: { margin: "5px 5px 5px 5px" } },
        React.createElement(
          "div",
          { style: s4 },
          React.createElement("span", { style: s1, className: "fa fa-instagram" })
        )
      )
    );
  }
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { style: s4 },
          React.createElement("span", { style: s1, className: "fa fa-google-plus" }),
          React.createElement(
            "div",
            { className: "white-text", style: { padding: "90px 0px 0px 0px" } },
            React.createElement(
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { className: "white-text" },
          React.createElement("p", { style: s1, className: "fa fa-google-plus" }),
          React.createElement(
            "p",
            { style: s2 },
            this.props.data.substr(0, 70) + "..."
  ...
  render: function () {
    ...
    var commentNodes = this.props.data.map(function (item, i) {
      return React.createElement(
        "div",
        null,
        item.VideoID ? item.VideoSource == "Youtube" ? React.createElement(ItemYoutube, { data: item.VideoID, text: item.Text, id: item.ProfileName }) : item.VideoSource == "Vimeo" ? React.createElement(ItemVimeo, { data: item.VideoID }) : false : item.PhotoUrl && item.Text != "" && item.Datasource == "Facebook" ? React.createElement(ItemFbTextPhoto, { photo: item.PhotoUrl, text: item.Text, id: item.ProfileName, href: "https://www.facebook.com/" + item.ProfileID + "/posts/" + item.ID.split("_")[1] }) : item.PhotoUrl && item.Datasource == "Facebook" ? React.createElement(ItemFbPhoto, { data: item.PhotoUrl, href: "https://www.facebook.com/" + item.ProfileID + "/posts/" + item.ID.split("_")[1] }) : (item.PhotoUrl == null || item.PhotoUrl == "null") && item.Text != "" && item.Datasource == "Facebook" ? React.createElement(ItemfbText, { data: item.Text, id: item.ProfileName, href: "https://www.facebook.com/" + item.ProfileID + "/posts/" + item.ID.split("_")[1] }) : (item.PhotoUrl == null || item.PhotoUrl == "null") && item.Text != "" && item.Datasource == "Twitter" && item.Sentiment == "Positive" ? React.createElement(ItemtwText, { data: item.Text, id: item.ProfileID, sentiment: "#4CAF50", href: "https://twitter.com/" + item.ProfileID.substr(1) + "/status/" + item.ID }) : (item.PhotoUrl == null || item.PhotoUrl == "null") && item.Text != "" && item.Datasource == "Twitter" && item.Sentiment == "Negative" ? React.createElement(ItemtwText, { data: item.Text, id: item.ProfileID, sentiment: "#d0181e", href: "https://twitter.com/" + item.ProfileID.substr(1) + "/status/" + item.ID }) : (item.PhotoUrl == null || item.PhotoUrl == "null") && item.Text != "" && item.Datasource == "Twitter" && item.Sentiment == "Neutral" ? React.createElement(ItemtwText, { data: item.Text, id: item.ProfileID, sentiment: "#9e9e9e", href: "https://twitter.com/" + item.ProfileID.substr(1) + "/status/" + item.ID }) : item.PhotoUrl && item.Text != "" && item.Datasource == "Twitter" ? React.createElement(ItemtwTextPhoto, { photo: item.PhotoUrl, text: item.Text, id: item.ProfileID, href: "https://twitter.com/" + item.ProfileID.substr(1) + "/status/" + item.ID }) : item.PhotoUrl && item.Text != "" && item.Datasource == "Googleplus" ? React.createElement(ItemgpTextPhoto, { photo: item.PhotoUrl, text: item.Text, id: item.ProfileName, href: "https://plus.google.com/" + item.ProfileID }) : item.PhotoUrl && item.Datasource == "Googleplus" ? React.createElement(ItemgpPhoto, { data: item.PhotoUrl, href: "https://plus.google.com/" + item.ProfileID }) : (item.PhotoUrl == null || item.PhotoUrl == "null") && item.Text != "" && item.Datasource == "Googleplus" ? React.createElement(ItemgpText, { data: item.Text, id: item.ProfileName, href: "https://plus.google.com/" + item.ProfileID }) : item.PhotoUrl && item.Datasource == "Instagram" ? React.createElement(ItemInstagramPhoto, { data: item.PhotoUrl, href: "https://instagram.com/" + item.ProfileID.substr(1) }) : item.PhotoUrl && item.Datasource == "Tumblr" ? React.createElement(ItemTmbTextPhoto, { photo: item.PhotoUrl, text: item.Text, id: item.ProfileName, href: "http://" + item.ProfileID + ".tumblr.com" }) : false
      );
    });
    ...
    return React.createElement(
      ...
      React.createElement(
        "header",
        { className: "content-module-header" },
        React.createElement(
          "div",
          { className: "row" },
          React.createElement(
...
React.render(React.createElement(CommentList, { data: data, id: id, title: title, returnurl: returnurl, type: type, q: q, container: container }), container);
...
var DetailWidgetRunner = (function () {
  var infiniteCardWidget = function (id, container, type, limit, q, dataFromPage, returnUrl) {
    ...
    jQuery.ajax({
      ...
      React.render(React.createElement(CommentList, { data: data, id: id, title: title, returnurl: returnurl, type: type, limit: limit, q: q, container: container }), container);
    });
  };
  return {
