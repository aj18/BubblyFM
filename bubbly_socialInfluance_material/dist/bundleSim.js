    ...
    render: function () {
        ...
        var tagNodes = this.props.data.map(function (item) {
            return React.createElement(
                ...
                React.createElement(
                    "button",
                    { className: "waves-effect waves-light btn red darken-4", type: "button", style: s2 },
                    item.key,
                    " ",
                    React.createElement(
                        "span",
    ...
    render: function () {
        ...
        var tagNodes = this.props.data.map(function (item) {
            return React.createElement(
                ...
                React.createElement(
                    "button",
                    { className: "waves-effect waves-light btn light-blue darken-4", type: "button", style: s2 },
                    "#",
                    item.key,
                    " ",
                    React.createElement(
                        "span",
                        { className: "circle badge", style: s3 },
                        item.value
                    )
                )
            );
