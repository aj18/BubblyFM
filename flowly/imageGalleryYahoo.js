...
var ImageGalleryYahoo = React.createClass({

    componentDidMount: function(){

      
    $(this.refs.amazingsliderbm.getDOMNode()).amazingslider({
                                ...
                                {this.props.data.map(function(item, i) {
                                    return(
                                        <li>
                                            ...
                                            <img src={item.Url} style={{'margin-top': '5px !important;'}}/>
...
//<PhotoFullImage url={item.Url}/>

module.exports = ImageGalleryYahoo;